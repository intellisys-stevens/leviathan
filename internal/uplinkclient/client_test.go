...
func TestDefaultRequestLimitMatchesFleetRegistry(t *testing.T) {
	if DefaultMaxRequestBytes != fleetuplink.DefaultMaxBodyBytes {
		t.Fatalf("client default = %d, registry default = %d", DefaultMaxRequestBytes, fleetuplink.DefaultMaxBodyBytes)
	}
}
