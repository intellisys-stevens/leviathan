...
describe('Leviathan brand assets', () => {
  it('ships the Leviathan mark and Yggdrasill platform assets', () => {
    ...
    expect(existsSync(`${publicDirectory}/yggdrasill.png`)).toBe(true);
    expect(existsSync(`${publicDirectory}/yggdrasill-favicon.png`)).toBe(true);
  });
